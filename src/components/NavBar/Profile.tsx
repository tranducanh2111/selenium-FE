...
import bookData from '@/dummy-data/bookData.json';
        ...
        <div className={isProfileOpen ? 'absolute right-0 w-full sm:w-[517px] bg-[#ECECEC] px-[20px] py-[40px] sm:px-[30px] space-y-[40px] z-20 sm:rounded-[12px]' : 'hidden'}>
            ...
            <div className='flex justify-between items-center'>
                ...
                <Link href={"#"} className="flex items-center max-w-content h-[30px] text-primary px-1 py-[4px] rounded-[2px] ml-auto">
                    <Button className='font-medium text-[#FF5A1A]' icon={ThinArrow} title='View more'/>
                </Link>
            </div>
            ...
            <div className='bg-[#FFFFFF] py-[12px] px-[24px] rounded-[8px] space-y-[40px]'>
                <div className='flex justify-between items-center'>
                    <h2 className='text-[30px] font-[500] leading-[32px]'>Viewed product</h2>
                    <Link href={"#"} className="flex items-center max-w-content h-[30px] text-primary px-1 py-[4px] rounded-[2px] ml-auto">
                        <Button className='font-medium text-[#FF5A1A]' icon={ThinArrow} title='View more'/>
                    </Link>
                </div>
                <div className='overflow-x-auto hide-scrollbar'>
                    ...
                    {bookData.books.slice(0,3).map((book, index) => (
                        <div className='flex justify-between space-x-[16px]' key={index}>
                            ...
                            <div>
                                ...
                                <button className='flex items-center justify-center space-x-[10px] py-[4px]'>
                                    <span className='max-w-content text-body text-[#FF5A1A] font-bold'>See details</span>
                                    <Image
                                    src={ArrowRight}
                                    alt="Logo"
                                    width={14}
            ...
            <button
                className=' h-[42px] bg-[#FF5A1A] w-full text-white text-h5 flex justify-center items-center rounded-[8px]'
            ...
            >
                ...
                <Image
                    ...
                    height={20}
                />
                <span className='ml-1 max-w-content text-base'>Log out</span>
                </span>
            </button>
        </div>
    </>
